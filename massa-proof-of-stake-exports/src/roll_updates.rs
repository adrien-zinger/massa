...
use massa_models::{Address, prehash::{Set, Map}, SerializeCompact, DeserializeCompact, ModelsError, SerializeVarInt, DeserializeVarInt};
use serde::{Serialize, Deserialize};

use crate::{RollCompensation, error::ProofOfStakeError};
...
impl RollUpdate {
    ...
    fn chain(&mut self, change: &Self) -> Result<RollCompensation, ProofOfStakeError> {
        ...
        self.roll_sales = self
            ...
            .ok_or_else(|| {
                ProofOfStakeError::InvalidRollUpdate("roll_sales overflow in RollUpdate::chain".into())
            })?;
