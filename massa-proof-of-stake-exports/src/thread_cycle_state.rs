...
use massa_models::{ModelsError, DeserializeCompact, Slot, array_from_slice, ADDRESS_SIZE_BYTES, Address, prehash::{BuildMap, Map}, with_serialization_context, SerializeCompact, SerializeVarInt, DeserializeVarInt};
use serde::{Serialize, Deserialize};

use crate::{RollUpdates, RollUpdate, roll_counts::RollCounts};
