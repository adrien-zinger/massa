use massa_models::{*, prehash::{Set, Map, BuildMap}, ledger::LedgerChange};
use serde::{Serialize, Deserialize};
use massa_proof_of_stake_exports::{RollUpdates, RollUpdate};
use crate::{active_block::ActiveBlock, ledger::LedgerChanges, error::{GraphResult as Result, GraphError}};
