use massa_models::{BlockId, prehash::{Map, Set, BuildMap}, clique::Clique, SerializeCompact, ModelsError, with_serialization_context, array_from_slice, BLOCK_ID_SIZE_BYTES, DeserializeCompact, DeserializeVarInt, SerializeVarInt};
